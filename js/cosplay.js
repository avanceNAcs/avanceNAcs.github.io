document.addEventListener("DOMContentLoaded", () => {
    ...
    // ✅ Shared helper: get card width including gap
    ...
    // ✅ Wrap-around scroll helpers
    function scrollNext() {
        const cardWidth = getCardWidth();
        const maxScroll = carousel.scrollWidth - carousel.clientWidth;
        scrollAmount += cardWidth;
        if (scrollAmount > maxScroll) scrollAmount = 0; // wrap to start
    ...
    function scrollPrev() {
        ...
        const maxScroll = carousel.scrollWidth - carousel.clientWidth;
        scrollAmount -= cardWidth;
        if (scrollAmount < 0) scrollAmount = maxScroll; // wrap to end
        carousel.scrollTo({ left: scrollAmount, behavior: "smooth" });
    }
